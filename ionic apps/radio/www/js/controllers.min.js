...
.controller('HomeCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicPopup", "Post", "Bookmark", "User", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, Post, Bookmark, User) {
...
.controller('MapCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$compile", function($scope, $timeout, $rootScope, $sce, $localstorage, $compile) {
...
.controller('ProgrammingCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicPopup", "PostTax", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, PostTax) {
...
.controller('RadioCtrl', ["$scope", "$timeout", "$interval", "$rootScope", "$sce", "$localstorage", "$ionicScrollDelegate", "WebAudio", "Stream", function($scope, $timeout, $interval, $rootScope, $sce, $localstorage, $ionicScrollDelegate, WebAudio, Stream) {
