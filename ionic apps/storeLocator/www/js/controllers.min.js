...
.controller('AllStoresCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", "$ionicPopup", "$ionicActionSheet", "Store", "mapView", "NgMap", function($scope, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, $ionicActionSheet, Store, mapView, NgMap) {
...
.controller('LocationCtrl', ["$scope", "$ionicModal", "$timeout", "$sce", "$ionicPlatform", "$ionicPopup", "$ionicScrollDelegate", "$ionicActionSheet", "item", "NgMap", function($scope, $ionicModal, $timeout, $sce, $ionicPlatform, $ionicPopup, $ionicScrollDelegate, $ionicActionSheet, item, NgMap) {
...
.controller('TabsStoresCtrl', ["$scope", "$timeout", "$rootScope", "$sce", "$localstorage", function($scope, $timeout, $rootScope, $sce, $localstorage) {
