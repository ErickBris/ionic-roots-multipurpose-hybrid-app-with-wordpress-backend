...
.controller('CategoriesMenuCtrl', function($scope, $ionicModal, $timeout, $sce, $localstorage, Category) {

	$scope.categories = [];
	$scope.isFetching = true;	
	$scope.shouldRefresh = false;

	$scope.localStoragePrefix = 'category_doctor_index_'; 
	...
	$scope.getCategories = function(){
		...
		Category.get('full', 'doctor_cat', 'name').success(function(response){
