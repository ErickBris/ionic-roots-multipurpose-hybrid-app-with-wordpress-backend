...
.controller('CategoryMenuArchiveCtrl', function($scope, $ionicModal, $timeout, $rootScope, $sce, $localstorage, $ionicPopup, category, PostTax, Bookmark) {
	...
	$scope.localStoragePrefix = 'category_doctors_' + $scope.category.id + '_'; 
	...
	$scope.getPosts = function(){
		...
		PostTax.get($scope.settings.current_page, 'doctor', 'doctor_cat', $scope.category.slug, $scope.items_per_page).success(function(response){
