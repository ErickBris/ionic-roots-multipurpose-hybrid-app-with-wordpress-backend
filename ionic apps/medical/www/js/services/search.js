...
.factory('Search', function($http, $filter) {
	...
	return {
		...
		query: function(keyword, page, posts_per_page) {
			return $http.jsonp(api+'roots/get_search_results/?search='+keyword+'&page='+page+'&post_type=' + post_type +'&posts_per_page='+ posts_per_page +'&callback=JSON_CALLBACK');
		}
	};
